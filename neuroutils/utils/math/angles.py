...
def calc_included_angles_from_vectors(
    vecs1: np.ndarray,
    vecs2: np.ndarray,
    *,
    return_rad: bool = False,
    ...
    """Compatibility alias for included angle computation from vectors."""
    return included_angles_from_vectors(
        vecs1,
        vecs2,
        return_rad=return_rad,
...
def calc_included_angles_from_coords(
    ...
    *,
    ...
    """Compatibility alias for included angle computation from coordinates."""
